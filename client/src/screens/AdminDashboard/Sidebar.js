  ...
  return (
    <>
      <div className={`${styles.sidebar_head} spacing-md`}>
        ...
        <h6>{currentUser.role === "admin" && "Admin"} </h6> 
      </div>
      <ul className={`${styles.sidebar_tabs}`}>
        <ActiveLink 
          icon={<GrTransaction className={styles.sidebar_tab_icon} />}
          label={<Link to={`/admin/dashboard/`} className={`${styles.sidebar_tab}`}>Dashboard</Link>}
          eventKey="dashboard"
        ...
        <ActiveLink 
          ...
          label={<Link to={`/admin/dashboard/profile`} className={`${styles.sidebar_tab}`}>My Profile</Link>}
          eventKey="profile"
          setActiveLink={setActiveLink}
          activeLink={activeLink}
        />
        <ActiveLink 
          icon={<AiOutlineUser className={styles.sidebar_tab_icon} />}
          label={<Link to={`/admin/dashboard/profiles`} className={`${styles.sidebar_tab}`}>All users</Link>}
          eventKey="profiles"
          setActiveLink={setActiveLink}
          activeLink={activeLink}
        />
